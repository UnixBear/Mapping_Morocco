...
//import Toronto data
const morocco = "https://raw.githubusercontent.com/manalhama/Morocco-geojson/master/maroc.geojson" 
...
d3.json(morocco).then(function(data) {
    console.log(data);
    // Create a GeoJSON layer with the retrieved data
    var mLayer = L.geoJson(data, {
        style: myStyle,
        onEachFeature: function(feature,layer) {
            layer.bindPopup("<h2>Region: " + feature.properties.region + "</h2>");
        }
    });
    mLayer.addTo(map);
});
